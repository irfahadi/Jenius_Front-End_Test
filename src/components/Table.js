      ...
      {Contact?.length>0?(
        Contact.map((x) => (
          ...
          >
            ...
            />
            <div className="w-1/3 pl-5  md:pl-16 lg:pl-28">{x.firstName}</div>
            <div className="w-1/3 pl-5 md:pl-16 lg:pl-32">{x.lastName}</div>
            <div className="w-1/3 pl-1  md:pl-20 lg:pl-40">{x.age}</div>
          </button>
        ))
      )
      :
